...
# Custom Instructions for your VS Code
- github.copilot.chat.codeGeneration.instructions
-In your settings.json, it looks like this:


"github.copilot.chat.codeGeneration.instructions": [
  { "text": "Always add 'Generated by Copilot' comment at the top." },
  { "file": ".github/copilot-instructions.md" }
],
"github.copilot.chat.codeGeneration.useInstructionFiles": true

- Press Ctrl + Shift + P (Windows/Linux) or ⌘ + Shift + P (macOS).
- Type “Preferences: Open User Settings (JSON)” (or on some setups just “settings (JSON)”) and select it.
- This will open the global settings.json where you can edit user-level settings 
